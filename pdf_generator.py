...
def generate_user_guide_pdf(output_path="ContextIQ_User_Guide.pdf"):
    ...
    pdf.cell(0, 8, "Multi-Model Support", 0, 1)
    ...
    pdf.set_font('Arial', 'B', 11)
    pdf.cell(0, 8, "Conversation History", 0, 1)
    pdf.set_font('Arial', '', 11)
    pdf.multi_cell(0, 6,
    ...
    pdf.set_font('Arial', 'B', 11)
    pdf.cell(0, 8, "Web Search Integration", 0, 1)
    pdf.set_font('Arial', '', 11)
    pdf.multi_cell(0, 6,
    ...
    pdf.set_font('Arial', 'B', 11)
    pdf.cell(0, 8, "Streaming Responses", 0, 1)
    pdf.set_font('Arial', '', 11)
    pdf.multi_cell(0, 6,
